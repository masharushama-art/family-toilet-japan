...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://familytoiletjapan.com/guide/yokohama-family-travel-tips",
    languages: {
      en: "https://familytoiletjapan.com/guide/yokohama-family-travel-tips",
      ja: "https://familytoiletjapan.com/ja/guide/yokohama-family-travel-tips",
      "zh-TW": "https://familytoiletjapan.com/zh/guide/yokohama-family-travel-tips",
      ko: "https://familytoiletjapan.com/ko/guide/yokohama-family-travel-tips",
    },
  },
};
...
export default function YokohamaFamilyPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <GuideScrollTracker slug="yokohama-family-travel-tips" lang="en" />
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        <GuideAreaLinks slug="yokohama-family-travel-tips" lang="en" />

        <div className="bg-gray-50 dark:bg-gray-800/40 rounded-2xl p-6 mb-8">
          <h2 className="font-bold text-gray-800 dark:text-gray-100 mb-3">Find Toilets in Yokohama</h2>
