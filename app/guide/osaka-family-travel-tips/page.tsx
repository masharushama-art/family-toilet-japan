...
export default function OsakaFamilyPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <GuideScrollTracker slug="osaka-family-travel-tips" lang="en" />
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        <GuideAreaLinks slug="osaka-family-travel-tips" lang="en" />

        <div className="bg-gray-50 dark:bg-gray-800/40 rounded-2xl p-6 mb-8">
          <h2 className="font-bold text-gray-800 dark:text-gray-100 mb-3">Find Toilets in Osaka</h2>
