      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        {spots.map(({ area, icon, places }) => (
          <div key={area} className="mb-8">
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">{icon} {area}</h2>
        ...
        <GuideAreaLinks slug="best-baby-changing-facilities-tokyo" lang="en" />

        <div className="bg-gray-50 dark:bg-gray-800/40 rounded-2xl p-6 mb-8">
          <h2 className="font-bold text-gray-800 dark:text-gray-100 mb-3">Find More on the Map</h2>
