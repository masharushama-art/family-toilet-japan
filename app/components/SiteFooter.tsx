...
const T: Record<Lang, {
  ...
  privacy: string; attribution: string; contact: string; report: string;
  ...
  en: {
    ...
    privacy: "Privacy Policy", attribution: "Data Sources & Attribution", contact: "Contact", report: "Data Report",
  ...
  ja: {
    ...
    privacy: "プライバシーポリシー", attribution: "データ出典", contact: "お問い合わせ", report: "データレポート",
  ...
  zh: {
    ...
    privacy: "隱私權政策", attribution: "資料來源", contact: "聯絡我們", report: "資料報告",
  ...
  ko: {
    ...
    privacy: "개인정보 처리방침", attribution: "데이터 출처", contact: "문의하기", report: "데이터 리포트",
    ...
    <footer className="mt-auto border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 text-sm">
      <div className="max-w-5xl mx-auto px-6 py-10 grid gap-8 md:grid-cols-3">
        ...
        <nav aria-label="Site" className="grid grid-cols-2 gap-x-6 gap-y-2">
          ...
          <Link href={lang === "ja" ? "/ja/coverage" : "/coverage"} className={linkCls}>{t.report}</Link>
